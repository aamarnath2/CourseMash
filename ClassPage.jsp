...
<% 
			...
			FOR NOTIFICATION, one column on the right most
...
<script>
	...
	function sendMessage() {
		socket.send("New Notification in Class XXX \n Post YYY");
		/* socket.send("X-Men: " + document.chatform.message.value); */
		return false;
	}
</script>
...
<body onload="connectToServer()">
	<h1>
		<a href="UserClassList.jsp"> CourseMash </a>
	</h1>
